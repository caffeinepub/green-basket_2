...
export class Backend implements backendInterface {
    ...
    async addOrder(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addSubscription(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSubscription(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActiveSubscriptions(): Promise<Array<Subscription>> {
        if (this.processError) {
            try {
    ...
    async updateDeliveryAddress(arg0: string): Promise<void> {
        if (this.processError) {
            try {
